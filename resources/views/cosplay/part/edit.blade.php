    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-sm-4">
            ...
            <ol class="breadcrumb">
                ...
                <li>
                    <a href="{{ route('admin.cosplay.show',$part->cosplay) }}">{{ $part->cosplay->name }}</a>
                </li>
                <li class="active">
        ...
        <div class="col-sm-8">
            <div class="title-action">
                <a href="{{ route('admin.cosplay.show',$part->cosplay) }}" class="btn btn-danger">Vovler</a>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <form action="{{ route('admin.cosplay.parts.update',[$part->cosplay,$part]) }}" method="post">
                        {{ csrf_field() }}
                        {{ method_field('PUT') }}
                        <div class="ibox-content">
                            <div class="form-group">
                                <label for="exampleInputEmail1">Nombre</label>
                                <input type="text" class="form-control" name="name" placeholder="Nombre" value="{{ old('name',$part->name) }}">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="text-center">
                                    <label style="margin-top: 10px" id="porcetaje" >{{ old('progress',$part->progress) }}%</label>
                                    <input type="hidden" name="progress" id="txtprogress" value="{{ old('progress',$part->progress) }}">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1">Descripcion <small>(Opcional)</small></label>
                                <textarea name="description" id="" class="form-control" cols="30" rows="10">{{ old('description',$part->description) }}</textarea>
                            </div>
                        </div>
...
@section('scripts')
    ...
    <script>
        ...
        noUiSlider.create(slider, {
            start: {{ old('progress',$part->progress) }},
            step: 5,
            animate: false,
            range: {
                min: 0,
