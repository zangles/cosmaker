                ...
                <div class="ibox">
                    <div class="ibox-content">
                        ...
                        <div class="row">
                            <div class="col-lg-5">
                                <dl class="dl-horizontal">
                                    <dt>Creado por:</dt> <dd>{{ $cosplay->users()->first()->cosplayer_name }}</dd>
                                    <dt>Presupuesto:</dt> <dd>  $ 300.00</dd>
                                    <dt>Gastado:</dt> <dd>$ 132.00</dd>
                                    <dt>Disponible:</dt> <dd>$ 168.00</dd>
                                </dl>
                            </div>
                            <div class="col-lg-7" id="cluster_info">
                                <dl class="dl-horizontal" >

                                    <dt>Creado:</dt> <dd>{{ Carbon::parse($cosplay->created_at)->format('d/m/Y') }}</dd>
                                    <dt>Fecha limite:</dt> <dd>{{ Carbon::parse($cosplay->created_at)->format('d/m/Y') }}</dd>
                                    <dt>Participantes:</dt>
                                    <dd class="project-people">
                                        @foreach($cosplay->users()->get() as $user)
                                            <a href="#">{{$user->cosplayer_name}}</a>
                            ...
                            <div class="col-lg-12">
                                <dl class="dl-horizontal">
                                    ...
                                    <dd>
                                        ...
                                        <small>Cosplay completado al <strong>60%</strong>.</small>
                                    </dd>
                                </dl>
                            </div>
                        </div>
